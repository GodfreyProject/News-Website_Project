    ...
    public class VipModel : PageModel
    {
        ...
        public IActionResult OnPost()
        {
            ...
            else
            {
                ...
                if (subscribeManager.Subscribe(customer.FirstName, customer.LastName, customer.Email, "€35.00", GetSub.Month, "Payed"))
                {
        ...
        public void NewsSubscriber()
        {
            ...
            emailManager.NewSubScriber(customer.FirstName, customer.LastName, customer.Email, "€35.00", GetSub.Month, "Payed");
        }
