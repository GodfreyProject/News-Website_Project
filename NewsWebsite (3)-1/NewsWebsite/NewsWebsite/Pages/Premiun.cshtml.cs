...
{
    public class PremiunModel : PageModel
    {
        ...
        public IActionResult OnPost()
        {
            ...
            if (String.IsNullOrEmpty(GetSub.Month))
            {
            ...
            else
            {
                ...
                if (subscribeManager.Subscribe(customer.FirstName, customer.LastName, customer.Email, "€15.00", GetSub.Month, "Payed"))
                {
                ...
                return new RedirectToPageResult("Premiun");
            }

            return Page();
        }

        public void NewsSubscriber()
        {
            EmailManager emailManager = new EmailManager();
            emailManager.NewSubScriber(customer.FirstName, customer.LastName, customer.Email, "€15.00", GetSub.Month, "Payed");
        }
